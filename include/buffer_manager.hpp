...
#include <list>
#include <memory>
// TODO not required for nomadic buffers
#include <mutex>
#include <type_traits>
// TODO not required for nomadic buffers
...
public:
  ...
  // TODO (daissgr) Gone for nomadic buffers (ifdef?)
  template <typename T, typename Host_Allocator>
...
private:
  ...
  public:
    ...
    static T *get(size_t number_of_elements, bool manage_content_lifetime) {
      ...
      // TODO (daissgr) Goody: unordered map over buffer size, then list?
